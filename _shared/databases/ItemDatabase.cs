...
public class ItemDatabase : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int tier = 0; tier < N_TIERS; tier++)
        {
            ...
            items.Add(new Item(Hun_Items[tier][1], Item.UseAs.LeftHand, new PlayerStats.PlayerClass[] { PlayerStats.PlayerClass.Hunter }, new float[] { Hun_Left_Hand_1 * multiplier, Hun_Left_Hand_2 * multiplier, 0f, 0f, 0f, 0f, 0f, 0f, 0f }, lvl, Item.Restrictions.tradeable));
        ...
        */
        ...
        items.Add(new Item(2205, Item.UseAs.Ring, new PlayerStats.PlayerClass[] { PlayerStats.PlayerClass.Any }, new float[] { 0f, 0f, 0f, HP_Accessory, MP_Accessory, 0f, 0f, Crit_Accessory, 0f }, 30, Item.Restrictions.tradeable)); //HP+MP+DODGE
