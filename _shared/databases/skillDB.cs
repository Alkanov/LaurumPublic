...
public class skillDB : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //---------------Utility
        //Charge                                                                                                                                                     
        Skills.Add(new skill(61006, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Warrior, 30f, 0.8f, new float[2] { 25f, 10f }, 10));//buff/time
        //Provoke
        ...
        //Frozen Hands
        Skills.Add(new skill(62008, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Wizard, 30f, 0.8f, new float[2] { 10f, 25f }, 25));//time
        //Blizzard
        ...
        //Hunter's Ritual
        Skills.Add(new skill(63012, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Hunter, 30f, 0.2f, new float[2] { 50f, 10f }, 15));//buff/time
        //Camouflage
        ...
        Skills.Add(new skill(64002, skill.SAction.active, skill.Stype.totem_spawn, PlayerStats.PlayerClass.Paladin, 15f, 0.4f, new float[2] { 35f, 10f }, 20));  //def/time
        //Physical Protection totem
        Skills.Add(new skill(64003, skill.SAction.active, skill.Stype.totem_spawn, PlayerStats.PlayerClass.Paladin, 15f, 0.4f, new float[2] { 35f, 10f }, 20)); //def/time
        //Linked Hearts
