...
public class skillDB : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Execution
        Skills.Add(new skill(61016, skill.SAction.active, skill.Stype.target_damage, PlayerStats.PlayerClass.Warrior, 4f, 0.5f, new float[2] { 2f, 30f }, 20));//damage/% requirement
        //Armor Crusher
        Skills.Add(new skill(61024, skill.SAction.active, skill.Stype.target_debuff, PlayerStats.PlayerClass.Warrior, 10f, 0.2f, new float[3] { -35f, 100f, 5f }, 12));//decreased def/chance/time
        //Dismember
        ...
        //---------------Utility
        //Charge                                                                                                                                                     
        Skills.Add(new skill(61006, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Warrior, 12f, 0.8f, new float[2] { 40f, 5f }, 10));//buff/time
        //Provoke
        ...
        //Ultimate Defense
        Skills.Add(new skill(61020, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Warrior, 15f, 0.8f, new float[2] { 35f, 10f }, 10));//buff/time
        //Arrow Deflect
        Skills.Add(new skill(61028, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Warrior, 10f, 0.2f, new float[2] { 35, 5f }, 12));//buff/time
        //Shields Up
        ...
        //---------------Ice
        //Ice Spear
        Skills.Add(new skill(62006, skill.SAction.active, skill.Stype.target_damage, PlayerStats.PlayerClass.Wizard, 1.25f, 0.4f, 1.4f, 28));
        //Frost Blade
        ...
        //Frozen Hands
        Skills.Add(new skill(62008, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Wizard, 16f, 0.2f, new float[1] { 15f }, 25));//time
        //Blizzard
        ...
        //---------------Marskman
        //Snipe
        Skills.Add(new skill(63001, skill.SAction.active, skill.Stype.target_damage, PlayerStats.PlayerClass.Hunter, 4f, 0.5f, 1.8f, 25));
        //Hawkeye
        ...
        //Steady shot
        Skills.Add(new skill(63004, skill.SAction.active, skill.Stype.target_damage, PlayerStats.PlayerClass.Hunter, 1f, 0.2f, 1.2f, 18));
        //Hamstring shot
        Skills.Add(new skill(63005, skill.SAction.active, skill.Stype.target_damage, PlayerStats.PlayerClass.Hunter, 5f, 0.3f, new float[3] { 1.5f, 100f, 20f }, 20));//damage/chance/effect
        //---------------Survival
        //Poison Arrow
        Skills.Add(new skill(63006, skill.SAction.active, skill.Stype.target_damage, PlayerStats.PlayerClass.Hunter, 5f, 0.4f, new float[2] { 1.5f, 100f }, 20));//damage/chance
        //Multi trap
        Skills.Add(new skill(63007, skill.SAction.active, skill.Stype.trap, PlayerStats.PlayerClass.Hunter, 10f, 1f, 1.6f, 28));
        //Posion Trap
        Skills.Add(new skill(63008, skill.SAction.active, skill.Stype.trap, PlayerStats.PlayerClass.Hunter, 4f, 0.3f, 1.6f, 22));//damage
        //Steel trap
        Skills.Add(new skill(63009, skill.SAction.active, skill.Stype.trap, PlayerStats.PlayerClass.Hunter, 6f, 0.3f, 1.5f, 20));
        //Booby Trap
        Skills.Add(new skill(63010, skill.SAction.active, skill.Stype.trap, PlayerStats.PlayerClass.Hunter, 5f, 0.3f, 1.6f, 22));
        //---------------Util
        //Hunters Mark
        Skills.Add(new skill(63011, skill.SAction.active, skill.Stype.target_debuff, PlayerStats.PlayerClass.Hunter, 10f, 0.2f, new float[3] { 5f, 50f, 30f }, 18));//time//threshold/extra damage
        //Hunters Ritual
        ...
        //Acrobatics
        Skills.Add(new skill(63015, skill.SAction.active, skill.Stype.selfBuff, PlayerStats.PlayerClass.Hunter, 15f, 0.4f, new float[2] { 100f, 3f }, 15));//effect/time
        ...
        Skills.Add(new skill(64002, skill.SAction.active, skill.Stype.totem_spawn, PlayerStats.PlayerClass.Paladin, 2f, 0.2f, 35f, 18));
        //Physical Protection totem
        Skills.Add(new skill(64003, skill.SAction.active, skill.Stype.totem_spawn, PlayerStats.PlayerClass.Paladin, 2f, 0.2f, 35f, 18));
        //Linked Hearts
        ...
        //Heal totem
        Skills.Add(new skill(64008, skill.SAction.active, skill.Stype.totem_spawn, PlayerStats.PlayerClass.Paladin, 10f, 0.4f, 70f, 18));
        //Resurrection
        Skills.Add(new skill(64009, skill.SAction.active, skill.Stype.AOE_revive, PlayerStats.PlayerClass.Paladin, 30f, 2f, 75f, 18));
        //Cleanse
        Skills.Add(new skill(64010, skill.SAction.active, skill.Stype.AOE_cleanse, PlayerStats.PlayerClass.Paladin, 6f, 1f, 5f, 18));
        //Mana totem
        Skills.Add(new skill(64011, skill.SAction.active, skill.Stype.totem_spawn, PlayerStats.PlayerClass.Paladin, 15f, 0.4f, new float[1] { 42f }, 18));//value
        //Silence
