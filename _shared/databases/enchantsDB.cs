...
public class enchantsDB : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        enchant_db.Add(new enchant(
            ...
            new List<float[]> {
                new float[3] {10f,20f,30f},
                new float[3] {12f,24f,36f},
                new float[3] {18f,36f,54f},
                 new float[3] {22f,44f,66f},
                new float[3] {33f,66f,99f}
            },
            40f));
        //Lazuli - corrupted
        enchant_db.Add(new enchant(
     ...
     new List<float[]> {
                new float[3] {3f,6f,9f},
                new float[3] {4f,8f,12f},
                new float[3] {5f,10f,15f},
                 new float[3] {6f,12f,18f},
                new float[3] {7f,14f,21f}
     },
     10f));
